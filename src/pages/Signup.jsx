...
const Signup = () => {
    ...
    return (
        <Container fluid className="signup-container d-flex flex-column flex-lg-row">

            <Row className="border border-primary access-form d-flex flex-column flex-lg-row">
